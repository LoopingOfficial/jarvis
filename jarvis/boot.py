...
class BootModel:
    ...
    def banner_sub(self) -> str:
        ...
        if self.outcome in ("blocked", "failed"):
            return self.message or "Utilise JARVIS_DOCTOR.bat pour le diagnostic détaillé."
...
class BootController:
    ...
    def request_doctor(self) -> bool:
        """Bouton « OUVRIR LE DIAGNOSTIC » : lance JARVIS_DOCTOR.bat."""
...
class BootScreen:
    ...
    def show_failure(self, model: BootModel) -> None:
        ...
        for item, text, color in (
            ...
            (self._fail_items[3],
             f"SUGGESTION : lance JARVIS_DOCTOR.bat pour le diagnostic détaillé."
