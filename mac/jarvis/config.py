...
DEFAULT_SETTINGS: dict[str, dict[str, Any]] = {
    ...
    "voice": {
        ...
        "speak_emojis": False,
        # Reconnaissance vocale : "browser" (Web Speech API) ou "local"
        # (faster-whisper sur la machine, seul mode qui marche hors Chrome).
        "stt_provider": "browser",
        "stt_model": "small",
        # Mode d'écoute : push_to_talk | always_listening | wake_word | conversation
        "mode": "wake_word",
        "wake_word": "jarvis",
        "wake_word_aliases": ["jarvice", "djarvis", "jarvi", "jarvie", "jarvis."],
    ...
    "blog": {
        "discord_channel_id": "1444705266825166972",
        "auto_editorial": True,
    ...
    # défaut : un assistant qui téléphone tout seul doit être demandé, jamais
    # subi. Les salons sont acceptés par identifiant OU par nom.
    "discord_call": {
        "enabled": False,
        "hour": 6,
        "minute": 0,
        "text_channel": "",            # salon privé où poser le ping
        "voice_channel": "📞-jarvis-line",
        "owner_user_id": "",           # mention du ping + voix écoutée
        "snooze_minutes": 5,
        "max_snoozes": 3,              # reports consécutifs avant rapport imposé
...
class SettingsStore:
    ...
    def _load(self) -> dict[str, dict[str, Any]]:
        with _lock:
            ...
            # Migration du build Blog V1: le mode sécurisé demandé est actif
            # même si une ancienne base avait seulement les valeurs initiales.
            if "blog" in data and data["blog"].get("auto_editorial") is False:
                data["blog"]["auto_editorial"] = True
                data["blog"]["auto_publish"] = False
                data["blog"]["auto_discord"] = False
