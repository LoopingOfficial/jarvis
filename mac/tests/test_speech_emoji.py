...
# ---------------------------------------------------------------------------
# Nombres français : le rapport matinal lit des pourcentages à voix haute, et
# la règle vigésimale (70-79, 90-99) ne se devine pas depuis la dizaine.
# ---------------------------------------------------------------------------
@pytest.mark.parametrize("value,expected", [
    ...
    (61, "soixante et un"),
    (70, "soixante-dix"),
    (71, "soixante et onze"),        # surtout pas « soixante-dix et un »
    (75, "soixante-quinze"),
    (79, "soixante-dix-neuf"),
    (80, "quatre-vingts"),           # le s tombe dès qu'un nombre suit
    (81, "quatre-vingt-un"),         # et pas « quatre-vingt et un »
    (90, "quatre-vingt-dix"),
    (91, "quatre-vingt-onze"),
    (99, "quatre-vingt-dix-neuf"),
])
def test_french_tens_follow_the_vigesimal_rule(value, expected):
    from jarvis.speech_sanitizer import _int_words

    assert _int_words(value) == expected


def test_percentage_in_a_report_line_is_spoken_correctly():
    spoken = sanitize_for_speech("Machine : mémoire à 71 pour cent.")
    assert "soixante et onze" in spoken
    assert "soixante-dix et un" not in spoken
